        ...
        <div class="ticket" aria-hidden="true">
            <div class="ticket__header">
                <div class="ticket__co">
                    ...
                    <span class="ticket__co-name">Reservation Ticket</span>
                    <span class="u-upper ticket__co-subname">If lost call : +1 23 23 23 23</span>
                </div>
            </div>
            <div class="ticket__body">
                <p class="ticket__route">{{$Reservation->event->title}}</p>
                ...
                <div class="ticket__timing">
                    <p>
                        ...
                        <span class="ticket__detail">{{$Reservation->event->start_date}}</span>
                    </p>
                    <p>
                        <span class="u-upper ticket__small-label">Price</span>
                        <span class="ticket__detail">{{$Reservation->event->price}}</span>
                    </p>
                    <p>
                        <span class="u-upper ticket__small-label">Seat Number</span>
                        <span class="ticket__detail">{{$Reservation->id}}</span>
                    </p>
                </div>
                <img class="ticket__barcode" src="{{$imageData}}" alt="Fake barcode" />
                <p class="ticket__fine-print">This ticket cannot be transferred to another attendent</p>
