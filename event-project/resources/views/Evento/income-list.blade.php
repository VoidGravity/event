                                                ...
                                                <div class="nk-tb-list nk-tb-ulist is-compact">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#746F5K2</a></span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#546H74W</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#87X6A44</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#986G531</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#326T4M9</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>21 Jan 2019</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#69X6445</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="{{route('Evento/invoice-details')}}">#4206469</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
