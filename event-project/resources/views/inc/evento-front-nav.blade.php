<div class="px-6 sm:px-4 xl:px-0 xl:px-4 flex flex-col">
    <div class="transition-all ease-linear duration-300 d3hxo23 overflow-hidden sm:overflow-visible">
            ...
            <div class="flex items-center space-x-10">
                ...
                <div class="m1t1fice hidden gl:block xmedia">
                    <form action="{{ route('front/search') }}" method="POST" id="search-form" class="outline-none w-full">
                        ...
                        </div><input id="hidden-location-search-submit" data-testid="hidden-location-search-submit" type="submit" class="sr-only absolute -left-96 sm:hidden" value="Submit">
                    </form>
                </div>
            </div>
        ...
        <div class="mb-2 mt-1 pointer-events-none block gl:hidden xmedia"></div>
    </div>
</div>
